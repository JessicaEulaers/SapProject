sap.ui.define([
	"sap/ui/test/Opa5",
	"be/ap/ZSD_03_SHIPM_MON/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("be.ap.ZSD_03_SHIPM_MON.test.integration.arrangements.Startup", {
